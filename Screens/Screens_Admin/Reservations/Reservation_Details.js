    ...
    render() {
        ...
        return (
            <ScrollView contentContainerStyle={styles.container}>
                <Text style={{color: 'black', fontWeight: 'bold', fontSize: 0.07*width}}> {info.date} </Text>
                <Text style={{color: 'black', paddingTop: 0.02*width, fontWeight: 'bold', fontSize: 0.05*width}}> {info.start_time} - {info.end_time}</Text>
